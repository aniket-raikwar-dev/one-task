...
const TaskLinkPreview = ({ taskData, openLinkModal, handleDeleteLink }) => {
  return (
    <div>
      <div className="flex items-center justify-between mb-4">
        <p className="font-semibold text-[15px]">Links :</p>
        <div className="btn-task-icon ml-5" onClick={openLinkModal}>
          <svg
      ...
      <div className="link-box">
        {taskData?.links?.length === 0 ? (
          ...
          taskData?.links?.map((item) => (
            <div key={item?.id} className="link-show">
              <p>
                {item?.link?.length > 35
...
export default TaskLinkPreview;
